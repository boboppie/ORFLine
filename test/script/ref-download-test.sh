...
cp ./test/ref/genome/genome_chr19.fa.gz $GENCODEDIR/fasta/genome/PRI/genome.fa.gz 
...
cp ./test/ref/transcriptome/all_transcripts_chr19.fa.gz $GENCODEDIR/fasta/transcriptome/CHR/all-transcripts/transcripts.fa.gz
...
cp ./test/ref/transcriptome/pc_transcripts_chr19.fa.gz $GENCODEDIR/fasta/transcriptome/CHR/protein-coding-transcripts/pc_transcripts.fa.gz
...
cp ./test/ref/annotation/annotation_chr19.gtf.gz $GENCODEDIR/annotation/CHR/comprehensive/annotation.gtf.gz
cp ./test/ref/annotation/annotation_chr19.gff3.gz $GENCODEDIR/annotation/CHR/comprehensive/annotation.gff3.gz
...
STAR --runThreadN $THREAD --runMode genomeGenerate --genomeDir $GENCODEDIR/star/50bp --genomeFastaFiles $GENCODEDIR/fasta/genome/CHR/genome.fa --sjdbGTFfile $SJ_GTF --sjdbOverhang 49 --genomeSAindexNbases 11 
...
STAR --runThreadN $THREAD --runMode genomeGenerate --genomeDir $GENCODEDIR/star/100bp --genomeFastaFiles $GENCODEDIR/fasta/genome/CHR/genome.fa --sjdbGTFfile $SJ_GTF --sjdbOverhang 99 --genomeSAindexNbases 11
