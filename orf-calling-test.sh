...
# Kepp all $19 == "NA" or $19 < 1
#LC_ALL=C fgrep -v -f $OUTPATH/region_filter/filtered_canonical_ORFId.txt $OUTPATH/region_filter/orfs_readRatio.tsv | awk '$19 == "NA" || $19 < 1' | cut -f6 >$OUTPATH/region_filter/filtered_NA_ORFId.txt
...
#cat $OUTPATH/rrs_filter/RRS_canonical.tsv $OUTPATH/region_filter/RRS_nonCanonical.tsv | sort -k2 -gr >$OUTPATH/rrs_filter/RRS_all.tsv
